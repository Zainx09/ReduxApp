  ...
  // },[])
    ...
    return (
      <View style={{ borderBottomWidth:1, borderColor:'#D4D4D4', marginVertical:0, padding:10 , paddingBottom:15}}>
        ...
        <Text style={{ fontSize:14, fontWeight:'bold', marginTop:8 , borderWidth:0, width:'85%'}}>ID : {props.pointData.id}</Text>
        <Text style={{ fontSize:14, fontWeight:'bold', marginTop:8 , borderWidth:0, width:'85%'}}>Name : {props.pointData.name}</Text>
      </View>
    )
}
